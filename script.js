...
const tracks = [
  { title: 'Lover',              artist: 'Taylor Swift ft Shawn',     note: 'Can we always be this close?',           file: 'lover ft shawn.wav'},
  { title: 'Jogi',               artist: 'Arko ft Aakanksha Sharma',  note: 'This one says it all',                   file: 'jogi.wav'},
  { title: 'Say My Name',        artist: 'Hozier',                    note: 'Every note, every word',                 file: 'say my name.wav'},
  { title: 'Thinking Out Loud',  artist: 'Ed Sheeran',                note: 'People fall in love in mysterious ways', file: 'thinking out loud.wav'},
  { title: 'Hero',               artist: 'Enrique Iglesias',          note: 'I would standby you forever',            file: 'hero.wav'},
];
...
(function () {
  ...
  const daylightAudio  = new Audio('daylight1.mp3');
  ...
  function openEnvelope() {
    ...
    setTimeout(() => {
      ...
      fadeInAudio(daylightAudio, 0.3, 2000);
    }, 500);
  }
